...
urlpatterns = [
    ...
    path('calendar/week/', views.MenstrualStatusWeekAPIView.as_view(), name='get_status_for_week'),
    path('calendar/week/<int:year>/<int:week>/', views.MenstrualStatusWeekAPIView.as_view(), name='get_status_for_week'),
    ...
    # path('send_email/', views.EmailSend.as_view())
]
